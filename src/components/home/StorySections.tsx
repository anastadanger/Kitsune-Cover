  ...
  return (
    <section id="stories" className="border-b-[3px] border-ink bg-mist">
      <div className="mx-auto max-w-content">
        <div className="flex flex-wrap items-end justify-between gap-4 px-0 pb-0 pt-6">
          <div>
          ...
          {collections.map((c, index) => {
            ...
            return (
              <article
                key={c.id}
                className={[
                  "grid min-h-[380px] grid-cols-1 overflow-hidden border-[3px] border-ink bg-paper [&+&]:-mt-[3px] lg:min-h-[380px]",
                  flip
              ...
              >
                <div
                  className={`relative min-h-[320px] overflow-hidden border-ink max-[1100px]:min-h-[320px] max-[1100px]:border-b-[3px] lg:min-h-full ${
                    flip
                ...
                <div
                  className={`flex flex-col justify-center px-6 py-8 sm:px-8 lg:py-6 ${
                    flip ? "lg:order-1" : ""
                  }`}
                >
